...
🥰 메인 분야는 ![안드로이드](https://img.shields.io/badge/-Android-3ddc84?style=for-the-badge&logo=android&logoColor=fff)이며, 최근 웹 개발에 관심이 들려 웹 개발쪽도 배우는 단계에 있습니다.
...
🔥 최근에는 `Dependency Injection`중 하나인 `Hilt`에 관심이 들려, `Hilt` + `ViewModel` + `Fragment`를 연구하고 있습니다. (밑 레포에서 확인 가능)<br />
